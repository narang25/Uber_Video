    ...
    return (
        <div>
            ...
            <div className='flex items-center justify-between p-3 bg-yellow-400 rounded-lg mt-4'>
                ...
                <h5 className='text-2xl font-bold'>₹{props.ride?.fare}</h5>
            </div>
            <div className='flex gap-2 justify-between flex-col items-center'>
                ...
                <div className='mt-5 w-full '>
                    ...
                    }} className=' bg-green-600 w-full text-white font-semibold p-3 px-10 rounded-lg text-lg'>Accept</button>

                    <button onClick={() => {
                        props.setRidePopupPanel(false)

                    }} className='mt-2 w-full bg-gray-200 text-gray-700 font-semibold p-3 px-10 rounded-lg'>Ignore</button>
                </div>
            </div>
        </div>
    )
